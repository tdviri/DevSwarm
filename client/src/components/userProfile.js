...
export default function UserProfile(props) {
  ...
  return (
    <div className="user-profile">
        ...
        {showNewQuestionForm && <NewQuestion fetchData={props.fetchData} handleAnswerPageIndex={props.handleAnswerPageIndex} userQuestion={questionToModify} userTags={userTags}/>}
    </div>
  );
}