...
export default function Forum(props) {
  ...
  return (
    <div id="forum" className="forum">
        {!props.displayTagsPage && props.displayAnswers && !props.displayAnswerForm && <Answers fetchData={props.fetchData} comments={props.comments} isLoggedIn={props.isLoggedIn} answers={props.answers} answerPageIndex={props.answerPageIndex} handleAskQuestionBtn={props.handleAskQuestionBtn} showAnswerForm={props.showAnswerForm} questions={props.questions} /> }
