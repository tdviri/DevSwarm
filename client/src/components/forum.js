...
export default function Forum(props) {
  ...
  return (
    <div id="forum" className="forum">
        ...
        {props.questions.length !== 0 && !props.displayTagsPage && <QuestionPosts setClickedOnTaggedQuestion={props.setClickedOnTaggedQuestion} clickedOnTag={props.clickedOnTag} isLoggedIn={props.isLoggedIn} comments={props.comments} fetchData={props.fetchData} goToWelcomePage={props.goToWelcomePage} isGuest={props.isGuest} loggedInuser={props.loggedInUser} tags={props.tags} answers={props.answers} setIsDisplayAnswerForm={props.setIsDisplayAnswerForm} handleAnswerPageIndex={props.handleAnswerPageIndex} answerPageIndex={props.answerPageIndex} questions={props.questions}/>}
        </div>}
        {props.displayTagsPage && <Tags setClickedOnTag={props.setClickedOnTag} isLoggedIn={props.isLoggedIn} setSearch={props.setSearch} setCurrentTag={props.setCurrentTag} setDisplayTagsPage={props.setDisplayTagsPage} tags={props.tags} handleAskQuestionBtn={props.handleAskQuestionBtn} />}
  </div>
  );
}